const destinations = [
  ...
  {
    id: 'd1', name: '제주도 (Jeju Island)', location: 'domestic', duration: ['day', '2-3', '4-5'], style: ['relaxation', 'nature', 'food'], bestSeasons: ['spring', 'summer', 'autumn'], image: 'https://loremflickr.com/800/600/jeju,nature/all', description: '에메랄드빛 바다와 아름다운 오름, 맛있는 흑돼지와 해산물이 있는 환상의 섬.',
    ...
    details: {
      ...
      courses: { 
        'day': '<br>1DAY: 애월 해안도로 드라이브 및 오션뷰 카페 투어 -> 협재 해수욕장 산책 -> 제주 동문시장 야시장', 
  ...
  {
    id: 'd2', name: '부산 (Busan)', location: 'domestic', duration: ['day', '2-3', '4-5'], style: ['city', 'food', 'nightlife'], bestSeasons: ['summer', 'autumn'], image: 'https://loremflickr.com/800/600/busan,city/all', description: '해운대의 화려한 야경과 맛있는 밀면, 돼지국밥! 활기찬 해양 도시.',
    ...
    details: {
      ...
      courses: { 
        'day': '<br>1DAY: 부산역 돼지국밥 -> 해운대 해변열차 탑승 -> 광안리 야경과 회센터', 
  ...
  {
    id: 'd3', name: '강릉/속초 (Gangneung/Sokcho)', location: 'domestic', duration: ['day', '2-3', '4-5'], style: ['relaxation', 'food', 'nature'], bestSeasons: ['summer', 'winter'], image: 'https://loremflickr.com/800/600/sokcho,beach/all', description: '시원한 동해 바다와 설악산, 그리고 신선한 회와 닭강정.',
  ...
  {
    id: 'd4', name: '경주 (Gyeongju)', location: 'domestic', duration: ['day', '2-3', '4-5'], style: ['history', 'culture', 'relaxation'], bestSeasons: ['spring', 'autumn'], image: 'https://loremflickr.com/800/600/gyeongju,temple/all', description: '천년의 역사가 숨 쉬는 곳. 황리단길의 트렌디함과 고즈넉한 한옥의 조화.',
  ...
  {
    id: 'd5', name: '여수 (Yeosu)', location: 'domestic', duration: ['day', '2-3', '4-5'], style: ['relaxation', 'food', 'nightlife'], bestSeasons: ['spring', 'autumn'], image: 'https://loremflickr.com/800/600/yeosu,night/all', description: '밤바다의 낭만과 맛있는 남도 음식이 가득한 아름다운 항구 도시.',
    ...
    details: {
      ...
      courses: { 
        'day': '<br>1DAY: 이순신광장 게장 정식 -> 오동도 산책 -> 해상케이블카 -> 낭만포차 거리', 
  ...
  {
    id: 'd6', name: '전주 (Jeonju)', location: 'domestic', duration: ['day', '2-3', '4-5'], style: ['history', 'culture', 'food'], bestSeasons: ['spring', 'autumn'], image: 'https://loremflickr.com/800/600/jeonju,hanok/all', description: '한국의 멋과 맛을 대표하는 가장 고풍스러운 한옥마을 투어.',
  ...
  {
    id: 'd7', name: '통영/거제 (Tongyeong/Geoje)', location: 'domestic', duration: ['day', '2-3', '4-5'], style: ['nature', 'relaxation', 'food'], bestSeasons: ['spring', 'summer'], image: 'https://loremflickr.com/800/600/tongyeong,ocean/all', description: '한국의 나폴리라 불리는 아름다운 다도해와 푸른 바다의 절경.',
    ...
    details: {
      ...
      courses: { 
        'day': '<br>1DAY: 통영 동피랑 벽화마을 -> 통영 케이블카 -> 거제 바람의 언덕 (드라이브 중심)', 
  ...
  {
    id: 'd8', name: '평창/강릉 (Pyeongchang)', location: 'domestic', duration: ['day', '2-3', '4-5'], style: ['nature', 'relaxation', 'family'], bestSeasons: ['summer', 'winter'], image: 'https://loremflickr.com/800/600/pyeongchang,nature/all', description: '여름에는 시원한 고원지대, 겨울에는 최고의 스키 리조트를 즐기는 청정 자연.',
  ...
  {
    id: 'i1', name: '오사카, 일본 (Osaka)', location: 'international', flight: 'short', duration: ['2-3', '4-6', '7-14'], style: ['food', 'city', 'shopping'], bestSeasons: ['spring', 'autumn', 'winter'], image: 'https://loremflickr.com/800/600/osaka,street/all', description: '먹다가 망한다는 미식의 도시. 화려한 도톤보리와 유니버셜 스튜디오.',
  ...
  {
    id: 'i2', name: '후쿠오카, 일본 (Fukuoka)', location: 'international', flight: 'short', duration: ['2-3', '4-6', '7-14'], style: ['food', 'relaxation', 'shopping'], bestSeasons: ['spring', 'autumn', 'winter'], image: 'https://loremflickr.com/800/600/fukuoka,food/all', description: '가깝고 맛있는 도시. 돈코츠 라멘의 본고장과 따뜻한 온천 여행.',
  ...
  {
    id: 'i13', name: '도쿄, 일본 (Tokyo)', location: 'international', flight: 'short', duration: ['2-3', '4-6', '7-14'], style: ['city', 'shopping', 'culture'], bestSeasons: ['spring', 'autumn'], image: 'https://loremflickr.com/800/600/tokyo,city/all', description: '현대와 전통이 공존하는 메가시티. 끝없는 쇼핑과 트렌드의 중심.',
  ...
  {
    id: 'i14', name: '삿포로, 일본 (Sapporo)', location: 'international', flight: 'short', duration: ['2-3', '4-6', '7-14'], style: ['nature', 'food', 'relaxation'], bestSeasons: ['winter', 'summer'], image: 'https://loremflickr.com/800/600/sapporo,snow/all', description: '겨울엔 끝없는 설경, 여름엔 보랏빛 라벤더가 가득한 홋카이도.',
  ...
  {
    id: 'i3', name: '타이베이, 대만 (Taipei)', location: 'international', flight: 'short', duration: ['2-3', '4-6', '7-14'], style: ['food', 'culture', 'nightlife'], bestSeasons: ['spring', 'autumn', 'winter'], image: 'https://loremflickr.com/800/600/taipei,night/all', description: '다채로운 길거리 음식과 지우펀의 야경, 친절한 사람들이 있는 곳.',
  ...
  {
    id: 'i15', name: '홍콩 (Hong Kong)', location: 'international', flight: 'short', duration: ['2-3', '4-6', '7-14'], style: ['city', 'shopping', 'food'], bestSeasons: ['autumn', 'winter'], image: 'https://loremflickr.com/800/600/hongkong,city/all', description: '백만불짜리 야경과 쇼핑, 딤섬의 천국. 동서양의 조화.',
  ...
  {
    id: 'i10', name: '오키나와, 일본 (Okinawa)', location: 'international', flight: 'short', duration: ['2-3', '4-6', '7-14'], style: ['relaxation', 'nature', 'family'], bestSeasons: ['spring', 'summer', 'winter'], image: 'https://loremflickr.com/800/600/okinawa,beach/all', description: '가깝게 만나는 에메랄드빛 바다. 여름 휴양으로 최고지만 9~10월 태풍은 조심하세요!',
  ...
  {
    id: 'i16', name: '세부, 필리핀 (Cebu)', location: 'international', flight: 'medium', duration: ['2-3', '4-6', '7-14'], style: ['relaxation', 'nature', 'adventure'], bestSeasons: ['winter', 'spring'], image: 'https://loremflickr.com/800/600/cebu,beach/all', description: '가성비 넘치는 리조트 휴양과 호핑투어, 고래상어 스노클링.',
  ...
  {
    id: 'i4', name: '다낭, 베트남 (Da Nang)', location: 'international', flight: 'medium', duration: ['2-3', '4-6', '7-14'], style: ['relaxation', 'food', 'family'], bestSeasons: ['spring', 'summer'], image: 'https://loremflickr.com/800/600/danang,beach/all', description: '가성비 최고의 휴양지. 아름다운 해변과 저렴하고 맛있는 로컬 푸드.',
  ...
  {
    id: 'i17', name: '코타키나발루 (Kota Kinabalu)', location: 'international', flight: 'medium', duration: ['2-3', '4-6', '7-14'], style: ['nature', 'relaxation', 'romantic'], bestSeasons: ['spring', 'summer'], image: 'https://loremflickr.com/800/600/kotakinabalu,sunset/all', description: '세계 3대 석양을 자랑하는 말레이시아의 청정 자연 휴양지.',
  ...
  {
    id: 'i5', name: '방콕, 태국 (Bangkok)', location: 'international', flight: 'medium', duration: ['2-3', '4-6', '7-14'], style: ['food', 'nightlife', 'shopping', 'culture'], bestSeasons: ['winter', 'spring'], image: 'https://loremflickr.com/800/600/bangkok,temple/all', description: '화려한 사원과 끝없는 길거리 음식, 저렴한 마사지와 생동감 넘치는 도시.',
  ...
  {
    id: 'i6', name: '괌 (Guam)', location: 'international', flight: 'medium', duration: ['2-3', '4-6', '7-14'], style: ['relaxation', 'shopping', 'family'], bestSeasons: ['winter', 'spring'], image: 'https://loremflickr.com/800/600/guam,ocean/all', description: '태평양의 에메랄드빛 바다. 쇼핑과 해양 스포츠를 동시에 즐길 수 있는 휴양지.',
  ...
  {
    id: 'i18', name: '싱가포르 (Singapore)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['city', 'food', 'family', 'shopping'], bestSeasons: ['summer', 'autumn'], image: 'https://loremflickr.com/800/600/singapore,city/all', description: '가장 안전하고 깨끗한 미래 도시. 마리나 베이 샌즈와 환상적인 야경.',
  ...
  {
    id: 'i19', name: '발리, 인도네시아 (Bali)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['relaxation', 'nature', 'romantic'], bestSeasons: ['summer', 'autumn'], image: 'https://loremflickr.com/800/600/bali,resort/all', description: '신들의 섬. 럭셔리 풀빌라와 요가, 서핑을 즐기는 평화로운 휴식처.',
  ...
  {
    id: 'i8', name: '하와이, 미국 (Hawaii)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['relaxation', 'nature', 'adventure', 'romantic'], bestSeasons: ['spring', 'summer', 'autumn', 'winter'], image: 'https://loremflickr.com/800/600/hawaii,resort/all', description: '지상 낙원. 완벽한 날씨, 아름다운 해변, 그리고 알로하 스피릿.',
  ...
  {
    id: 'i9', name: '시드니, 호주 (Sydney)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['city', 'nature', 'relaxation'], bestSeasons: ['winter'], image: 'https://loremflickr.com/800/600/sydney,opera/all', description: '오페라 하우스와 하버 브리지, 푸른 바다가 어우러진 남반구의 매력적인 도시.',
  ...
  {
    id: 'i20', name: '런던, 영국 (London)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['history', 'culture', 'city'], bestSeasons: ['summer', 'spring'], image: 'https://loremflickr.com/800/600/london,city/all', description: '신사의 나라. 빅벤과 타워브리지, 해리포터의 마법이 살아 숨 쉬는 곳.',
  ...
  {
    id: 'i7', name: '파리, 프랑스 (Paris)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['culture', 'history', 'shopping', 'romantic'], bestSeasons: ['spring', 'summer', 'autumn'], image: 'https://loremflickr.com/800/600/paris,eiffel/all', description: '에펠탑과 루브르 박물관, 낭만적인 센 강변을 거니는 유럽 여행의 로망.',
  ...
  {
    id: 'i11', name: '스위스 (Switzerland)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['nature', 'relaxation', 'adventure'], bestSeasons: ['summer'], image: 'https://loremflickr.com/800/600/switzerland,alps/all', description: '무더운 여름 유럽에서 시원하게 알프스 대자연을 즐길 수 있는 최고의 선택지.',
  ...
  {
    id: 'i21', name: '뉴욕, 미국 (New York)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['city', 'culture', 'shopping', 'food'], bestSeasons: ['autumn', 'spring'], image: 'https://loremflickr.com/800/600/newyork,city/all', description: '세계의 심장. 타임스퀘어와 센트럴파크, 브로드웨이 뮤지컬의 본고장.',
  ...
  {
    id: 'i12', name: '우유니 사막, 볼리비아 (Uyuni)', location: 'international', flight: 'long', duration: ['2-3', '4-6', '7-14'], style: ['nature', 'adventure'], bestSeasons: ['winter'], image: 'https://loremflickr.com/800/600/uyuni,salt/all', description: '직장인의 긴 연차를 100% 활용할 수 있는 지구 반대편의 초현실적인 소금 사막.',
